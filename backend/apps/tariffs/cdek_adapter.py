    ...
    def calculate_price(self, from_city: str = None, to_city: str = None, weight: float = None,
        ...
        try:
            ...
            if isinstance(result, list):
                    ...
                    if 'tariff_codes' in tariff:
                        for tariff_code_item in tariff['tariff_codes']:
                            ...
                            options.append({
                                ...
                                'company_name': 'CDEK',
                                'company_code': 'cdek',
                                    'price': float(tariff_code_item.get('total_sum', tariff_code_item.get('delivery_sum', 0))),
                ...
                delivery_sum = float(result.get('delivery_sum', 0))
                total_sum = float(result.get('total_sum', delivery_sum))
