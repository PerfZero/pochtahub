(function() {
    ...
    function initTransportCompanyAdmin() {
        var $ = (typeof django !== 'undefined' && typeof django.jQuery !== 'undefined') ? django.jQuery : (typeof jQuery !== 'undefined' ? jQuery : null);
        
        if (!$) {
            if (typeof window.addEventListener !== 'undefined') {
                window.addEventListener('load', initTransportCompanyAdmin);
            } else if (typeof window.attachEvent !== 'undefined') {
                window.attachEvent('onload', initTransportCompanyAdmin);
            }
            return;
        }
        ...
        $(document).ready(function() {
            ...
            function getCsrfToken() {
                return getCookie('csrftoken') || $('[name=csrfmiddlewaretoken]').val() || '';
            }
            ...
            function addLoadButton() {
                ...
                if ($tariffCodeRow.length === 0) {
                    $tariffCodeRow = $tariffCode.closest('.flex-container');
                }
                if ($tariffCodeRow.length === 0) {
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTransportCompanyAdmin);
    } else {
        initTransportCompanyAdmin();
    }
})();
