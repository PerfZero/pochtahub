        ...
        <button
          onClick={() => {
            if (
              ...
              window.ym(104664178, "params", { offers: "оплачу_сам" });
            }
            onPaymentPayerChange("me");
          }}
        ...
        <button
          onClick={() => {
            if (
              ...
              window.ym(104664178, "params", { offers: "получатель_оплатит" });
            }
            onPaymentPayerChange(
              selectedRole === "sender" ? "recipient" : "sender",
            );
          }}
          className={`p-4 md:p-6 rounded-xl border transition-all ${
            (selectedRole === "sender" && paymentPayer === "recipient") ||
            (selectedRole === "recipient" && paymentPayer === "sender")
              ? "border-[#0077FE] bg-[#F0F7FF]"
              : "border-[#E5E5E5] bg-white hover:border-[#0077FE]"
          }`}
        >
