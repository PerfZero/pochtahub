...
const sizeOptions = [
  { id: 'smartphone', name: 'Как коробка от смартфона', dimensions: '17х12х9 см', weight: 'до 1 кг', icon: iconPhone },
  { id: 'iron', name: 'Как коробка от утюга', dimensions: '21х20х11 см', weight: 'до 3 кг', icon: iconIron },
  { id: 'shoes', name: 'Как коробка от обуви', dimensions: '33х25х15 см', weight: 'до 7 кг', icon: iconShoes },
  { id: 'microwave', name: 'Как коробка от микроволновки', dimensions: '42х35х30 см', weight: 'до 15кг', icon: iconMicrowave }
]
...
function SenderWizard() {
  ...
  const {
    ...
    height, setHeight,
    weight, setWeight,
    estimatedValue, setEstimatedValue,
    photoFile, setPhotoFile,
    photoPreview, setPhotoPreview,
    photoError, setPhotoError,
    selectedSize, setSelectedSize,
    packageDataCompleted, setPackageDataCompleted,
    senderPhone, setSenderPhone,
    senderFIO, setSenderFIO,
    senderAddress, setSenderAddress,
    fioFocused, setFioFocused,
    ...
    recipientFIO, setRecipientFIO,
    recipientFioFocused, setRecipientFioFocused,
    email, setEmail,
    emailFocused, setEmailFocused,
    agreePersonalData, setAgreePersonalData,
    agreeMarketing, setAgreeMarketing,
    paymentPayer, setPaymentPayer,
    selectedOffer, setSelectedOffer,
    recipientDeliveryPointCode, setRecipientDeliveryPointCode,
    recipientDeliveryPointAddress, setRecipientDeliveryPointAddress,
    pickupAddress, setPickupAddress,
    pickupSenderName, setPickupSenderName,
    pickupSenderNameFocused, setPickupSenderNameFocused,
  } = wizardData
  ...
  const handleContinue = () => {
    ...
    } else if (currentStep === 'contactPhone' && contactPhone && !auth.codeSent) {
  ...
  const getProgressText = () => {
    ...
    if (['recipientPhone', 'pickupAddress', 'contactPhone'].includes(currentStep)) {
